...
//recebe todas validacoes possiveis do yup para traduzir.
//  ele e importado no server de modo a traduzir todas as validacoes do yup no projeto.
setLocale({
  mixed: {
    required: 'Preencha o campo, Este campo é obrigatório',
